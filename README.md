...
```
### Express, Elasticsearch and Body-parser
```sh
❯ cd path/to/workspace/caradisiac
...
❯ npm run dev
```
Then, you have to run Elasticsearch either locally or with a Docker image.
(I used a Docker Image so if you use ES locally, please change the ip address of the connection in the .api/routes/note_routes.js)
